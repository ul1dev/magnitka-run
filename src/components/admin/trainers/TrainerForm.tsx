...
export default function TrainerForm({ initial, id }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-2">
                <label className="text-sm opacity-70">Имя тренера*</label>
                <input
                    name="name"
            ...
            {/* Фото */}
            <div className="grid gap-2">
                <label className="text-sm opacity-70">Фото тренера</label>
                <FileInput
                    name="img"
